                    ...
                    <div class="gs-tools">
                        <div class="gs-voice-setting">
                            <div class="gs-voice-btn">
                                ...
                                <div class="voice_user_left visitor_id">辛逸</div>
                            </div>
                            <!-- 访客 -->
...
<li class="gs-qa-warning">
 ...
 <label class="cek_right">只看我</label>      </div>     </div>    
